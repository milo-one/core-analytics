# CoRE Analytics: strict EFA/SEM variant
#
# Run from the repository root in RStudio:
#   source("efa_sem_strict.R")
#
# This uses the shared pipeline in `efa_sem.R`, but tightens item-retention
# rules and excludes items that were weak or theoretically muddy in the first
# EFA-derived SEM run.
...
OUTPUT_DIR <- "tables/efa_sem_strict"
SEED <- 123
